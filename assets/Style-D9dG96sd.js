import{ap as w,aq as R,b9 as b,S,at as o,bi as p,r as j,ar as M,as as U,j as C,au as $,av as q,i as A}from"./index-BzybVbrz.js";import{a as X}from"./colorManipulator-BLd52KTc.js";import{r as D}from"./createSvgIcon-CZqlXMQ-.js";function E(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function L(t){return parseFloat(t)}function N(t){return w("MuiSkeleton",t)}R("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const P=["animation","className","component","height","style","variant","width"];let s=t=>t,m,f,g,v;const B=t=>{const{classes:a,variant:e,animation:i,hasChildren:r,width:l,height:n}=t;return q({root:["root",e,i,r&&"withChildren",r&&!l&&"fitContent",r&&!n&&"heightAuto"]},N,a)},F=b(m||(m=s`
  0% {
    opacity: 1;
  }
